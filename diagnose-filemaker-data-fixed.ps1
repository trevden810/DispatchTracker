# DispatchTracker: FileMaker Data Structure Diagnostic (Fixed)
...
try {
    # Fix the ampersand issue by constructing URL properly
    $activeJobsUrl = "https://www.pepmovetracker.info/api/jobs?active=true" + "&limit=10"
    $activeJobs = Invoke-RestMethod -Uri $activeJobsUrl -Method GET -TimeoutSec 15
